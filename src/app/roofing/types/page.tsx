        ...
        <section className="w-full py-12 md:py-20">
            <div className="container mx-auto px-4 md:px-6 text-center">
                 <h1 className="hero-heading uppercase">
                    PRECISION-BASED ROOFING IN FORT WORTH
                </h1>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 pt-6">
                            ...
                            <p className="content-description">
                                Protecting your home isn't as simple as a new roof installation. At US Roofing, we find ways to keep your family safe with endurance-based roofing services in FORT WORTH. We quell the storm with weather-resistant products that can be fully customized so that you can achieve better exterior performance and desirable curb appeal. Whether it's time to schedule reliable roof repairs or a residential roof replacement, we'll make sure your exterior is covered with top-of-the-line materials backed by manufacturer warranties.
                            </p>
                            <h3 className="content-heading uppercase pt-4">
                                COST-EFFECTIVE FORT WORTH ASPHALT SHINGLES
                            </h3>
                             <p className="content-description">
                                You deserve access to top-performing solutions at any budget. Since 2012, our family-owned FORT WORTH roofing company has specialized in top-rated materials for every home. Our FORT WORTH asphalt shingles are a cost-effective way to get long-term protection that's still stylish.
                            </p>
                        </div>
                    </div>
